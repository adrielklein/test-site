...
<img src="{{ base.url }}/assets/images/unscrew-rear.jpg" width="100%">

<img src="{{ base.url }}/assets/images/cut-off-end.jpg" width="100%">
...
<img src="{{ base.url }}/assets/images/wire-shifter.jpg" width="100%">

Pull the wire all the way through until you can't pull any further.

<img src="{{ base.url }}/assets/images/pull-wire.jpg" width="100%">

Next, you need to cut your new housing so that its length matches the old one.

<img src="{{ base.url }}/assets/images/match-length.jpg" width="100%">

Put on a housing caps to both ends of the housing.

<img src="{{ base.url }}/assets/images/housing-caps.jpg" width="100%">

Slide your housing onto the wire and place the end of it into the housing stop.

<img src="{{ base.url }}/assets/images/housing-stop.jpg" width="100%">

Thread the cable through the thing at the bottom of the frame.

<img src="{{ base.url }}/assets/images/bottom-of-frame.jpg" width="100%">

Repeat the same process for the other piece of housing.

<img src="{{ base.url }}/assets/images/other-end-housing-stop.jpg" width="100%">

<img src="{{ base.url }}/assets/images/pull-end.jpg" width="100%">
...
<img src="{{ base.url }}/assets/images/pull-hard.jpg" width="100%">
...
<img src="{{ base.url }}/assets/images/cut-end.jpg" width="100%">

Find your cable cap. It should look like this.
<img src="{{ base.url }}/assets/images/crimp.jpg" width="100%">

Put on your cable cap and squash it with the flat part of the wire cutters.
<img src="{{ base.url }}/assets/images/squash-crimp.jpg" width="100%">

<img src="{{ base.url }}/assets/images/final-product.jpg" width="100%">
